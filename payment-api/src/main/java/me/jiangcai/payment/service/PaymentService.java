...
public interface PaymentService {
    ...
    /**
     * 引导用户支付
     * 在支付完成之后发布{@link me.jiangcai.payment.event.OrderPaySuccess}事件并引导至{@link PayableSystemService#paySuccess(PayableOrder, PayOrder)}。
     ...
     */
    @Transactional
    ModelAndView startPay(PayableOrder order, PaymentForm form, Map<String, Object> additionalParameters) throws SystemMaintainException;
    // 之后用户或者客户项目会产生什么期待呢？
